...
namespace day05
{
    public class VentLine
    {
        ...
        public VentLine(string input)
        {
            ...
            var raw1 = split[0].Split(',');
            Coord1 = new Point(int.Parse(raw1[0]), int.Parse(raw1[1]));
            var raw2 = split[2].Split(',');
            Coord2 = new Point(int.Parse(raw2[0]), int.Parse(raw2[1]));
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var ventLines = (useTestInput ? testInput : input).Select(x => new VentLine(x));
            var mapWidth = ventLines.Max(x => x.Coord1.X > x.Coord2.X ? x.Coord1.X : x.Coord2.X) + 1;
            Console.WriteLine("mapWidth: " + mapWidth);
            var mapHeight = ventLines.Max(x => x.Coord1.Y > x.Coord2.Y ? x.Coord1.Y : x.Coord2.Y) + 1;
